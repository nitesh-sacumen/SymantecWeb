...
configClass      = SymantecGenerateActivationCode.Config.class)
public class SymantecGenerateActivationCode extends AbstractDecisionNode{
    ...
    public interface Config {
        ...
        @Inject
        public SymantecGenerateActivationCode(@Assisted Config config, CoreWrapper coreWrapper) throws NodeProcessException {
        ...
        public Action process(TreeContext context) throws NodeProcessException {
        	...
        	System.out.println("status of get Activation code api call  .. "+ status);
