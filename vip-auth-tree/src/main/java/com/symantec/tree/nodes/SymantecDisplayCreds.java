...
/** 
 * A node that displays Available Credentials to user
 * using which he can register to Symantec. 
 */
...
public class SymantecDisplayCreds implements Node {
    ...
    /**
     * This Node method displays available Credential options to the user.
     */
    @Override
