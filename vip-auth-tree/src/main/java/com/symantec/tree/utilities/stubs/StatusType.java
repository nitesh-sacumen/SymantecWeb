 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{https://schemas.vip.symantec.com/2006/08/vipservice}ReasonCode"/&gt;
...
public class StatusType {
    ...
    @XmlElement(name = "ReasonCode", required = true, type = String.class)
    @XmlJavaTypeAdapter(HexBinaryAdapter.class)
    @XmlSchemaType(name = "hexBinary")
    protected byte[] reasonCode;
     ...
     *     
     */
    public void setReasonCode(byte[] value) {
