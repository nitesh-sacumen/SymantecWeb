 ...
 * 
 * <p>Java class for ActivateTokenType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OTP1" type="{https://schemas.vip.symantec.com/2006/08/vipservice}OTPType" minOccurs="0"/&gt;
...
@XmlType(name = "ActivateTokenType", propOrder = {
    "otp1",
    "otp2"
})
public class ActivateTokenType
    extends TokenRequestType
{

    @XmlElement(name = "OTP1")
